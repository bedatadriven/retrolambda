...
/*non-public*/ class MethodHandleStatics {
    ...
    /*non-public*/ static Error newInternalError(String message) {
        return new InternalError(message);
    }
    /*non-public*/ static Error newInternalError(String message, Throwable cause) {
        return new Error(message, cause);
    }
    /*non-public*/ static Error newInternalError(Throwable cause) {
