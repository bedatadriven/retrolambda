...
import static net.orfjackal.retrolambda.invoke.MethodHandleStatics.newIllegalArgumentException;
...
class MethodType implements java.io.Serializable {
    ...
    private String methodDescriptor;  // cache for toMethodDescriptorString
    ...
    static final ConcurrentWeakInternSet<MethodType> internTable = new ConcurrentWeakInternSet<MethodType>();
...
//        return desc;
    ...
    private static class ConcurrentWeakInternSet<T> {
        ...
        public T get(T elem) {
            ...
            WeakEntry<T> value = map.get(new WeakEntry<T>(elem));
            if (value != null) {
                T res = value.get();
                if (res != null) {
                    return res;
